                ...
                <div class="box">
                    <div class="box-header with-border">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-6 col-md-4">
                                <button class="btn btn-info" onclick="edit()" id="btnEditar"><i
                                        class="fa fa-plus-circle"></i> Editar</button>
                                <button class="btn btn-danger" onclick="cancelar()" id="btnCancelar"><i
                    ...
                    <div class="panel-body" id="formularioregistros">
                        <form action="<?=base_url?>?controller=UsuarioController&action=save&id=<?=$usr->idusuario?>"
                            ...
                            <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <input type="text" class="form-control" name="nombre" id="nombre" maxlength="100"
                                    placeholder="Nombre" value="<?=$usr->nombre?>">
                            </div>
                            <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <label>Estatus</label>
                                <input type="email" class="form-control" name="estatus" id="estatus"
                                    placeholder="Estatus" value="<?= ($usr->estatus)?"Activado":"Desactivado";?>">
                            </div>
                            <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <label>Correo</label>
                            ...
                            <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <input type="text" class="form-control" name="telefono" id="telefono"
                                    placeholder="Teléfono" value="<?=$usr->telefono?>">
                            </div>
                            <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <label>Nombre de usuario</label>
                                <input type="text" class="form-control" name="username" id="username"
                                    placeholder="Nombre de usuario" value="<?=$usr->username?>">
                            </div>
                            <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <label>Contraseña</label>
                                <input type="password" class="form-control" name="contrasena" id="contrasena"
                                    placeholder="Contraseña" value="<?=$usr->contrasena?>">
                                <a
                                    href="<?=base_url?>?controller=UsuarioController&action=passform&id=<?=$usr->idusuario?>">Cambiar
                                    contraseña</a>
                            </div>
                            <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <input type="date" class="form-control" name="cumple" id="cumple"
                                    value="<?=$usr->cumple?>" required>
                            </div>
                            <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <label>Permisos:</label>
                                <?php $permisos = Utils::showPermisos();?>
                                <select multiple class="form-control" data-live-search="true" name="permisos[]"
                                    id="permisos">
                                    <?php while($pm = $permisos->fetch_object() ): ?>
                                    <option value="<?=$pm->idpermiso?>"
                                        <?=isset($usr) && is_object($usr) && $pm->idpermiso == $pm->idpermiso ? '' : 'selected';?>>
                                        <?=$pm->nombre?></option>
                                    <?php endwhile; ?>
                                </select>
                            </div>
                            <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="" name="permisos[]" id="permisos_act">
                                    ...
                                    <div class="row" style="margin: 1rem">
                                        ...
                                        <div class="col-md-6">
                                            <p id="btnElim" class="btn btn-danger btn-sm"
                                                onclick="deleteUsuarioPermiso(<?=$upm->idup?>)">Eliminar permiso</p>
                                        </div>
                                    </div>
                                    <?php endwhile; ?>
                                </div>
